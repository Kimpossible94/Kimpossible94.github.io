...
![JVM위치](/assets/images/JVM/JVM-1.png)  
...
![JVM구조](/assets/images/JVM/JVM-2.png)  
- **Runtime Data Area**  
...
<span style="font-size:11px">[JVM의 메모리 구조](#)</span>   
...
결과적으로 우리는 java 파일만 만든다면 어느 디바이스에서든 **JVM을 통해 OS와 상관없이 실행**이 가능한 것이다.  